(() => {
    ...
    document.getElementById("site-footer").innerHTML = `
     <div class="container px-4 xl:px-0 py-14">
     <div class="flex-1 md:flex-row justify-between text-white pb-10">
         ...
         <ul class="flex justify-center items-center flex-wrap gap-0.5 lg:gap-4 mt-5" data-aos="fade-up" data-aos-delay="100">
             <li>
                 <a href="#"
                     class="px-3 py-2 flex items-center gap-3 text-sm md:text-[1rem] font-semibold text-gray-200 hover:text-white rounded transition-colors duration-200">
     ...
     <div class="flex-1 flex-row gap-4 md:gap-6 border-t border-white/20 pt-8" data-aos="fade" data-aos-delay="600">
         <a href="https://in.linkedin.com/company/tricog-health">
         ...
         <a href="https://x.com/tricoghealth">
         ...
         <a href="https://www.facebook.com/tricog/">
            <svg class="lg:w-[28px] lg:h-[28px] w-10 h-10 text-white" aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                <path fill-rule="evenodd"
         ...
         <a href="https://www.youtube.com/channel/UCV-uGseptgruiCZrFuPz9SA">
             <svg class="lg:w-[28px] lg:h-[28px] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                 <path fill-rule="evenodd" d="M21.7 8.037a4.26 4.26 0 0 0-.789-1.964 2.84 2.84 0 0 0-1.984-.839c-2.767-.2-6.926-.2-6.926-.2s-4.157 0-6.928.2a2.836 2.836 0 0 0-1.983.839 4.225 4.225 0 0 0-.79 1.965 30.146 30.146 0 0 0-.2 3.206v1.5a30.12 30.12 0 0 0 .2 3.206c.094.712.364 1.39.784 1.972.604.536 1.38.837 2.187.848 1.583.151 6.731.2 6.731.2s4.161 0 6.928-.2a2.844 2.844 0 0 0 1.985-.84 4.27 4.27 0 0 0 .787-1.965 30.12 30.12 0 0 0 .2-3.206v-1.516a30.672 30.672 0 0 0-.202-3.206Zm-11.692 6.554v-5.62l5.4 2.819-5.4 2.801Z" clip-rule="evenodd"/>
               </svg>
         </a>
         <a href="https://www.instagram.com/tricoghealth/">
    ...
    header.innerHTML = `
    <!-- ── Top bar ────────────────────────────────────────────────── -->
    <div class="container mx-auto py-4 px-5 xl:px-0 flex items-center justify-between ">
